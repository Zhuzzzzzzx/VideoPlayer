...
/**
 * Created by Zhuzzzzzzx on 2017/5/18.
 */
...
public class ImageLoader {
    ...
    private Bitmap getBitmapFromMemoryCache(String url) {
        if(mMemoryCache.get(url) != null){
            Log.d(TAG,"从memory中找到"+url);
        }
        else {
            Log.d(TAG,"get  == null"+url);
        }
     ...
     * @param size mb
     */
    public ImageLoader setDiskCacheSize(int size){
     ...
     * @return
     */
    public ImageLoader setMultiple(int multiple){
        MULTIPLE = multiple;
        return this;
    }

    public ImageLoader setImagePlace(int id){
        imagePlaceID = id;
        return this;
    }
